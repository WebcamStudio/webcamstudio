...
abstract class Kernel extends QMatrix {
    ...
    static double k_function(svm_node[] x, svm_node[] y, svm_parameter param, int xlen) {
        double sum = 0;
...
//
class Solver_NU extends Solver
{
...
//			svm_predict_values(model, x, dec_values);
	...
	public static svm_model svm_load_model(java.io.InputStream in) throws IOException
	{
                java.io.DataInput din = new java.io.DataInputStream(in);
                
		//BufferedReader fp = new BufferedReader(null);
