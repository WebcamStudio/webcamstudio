...
public class StreamPanelURL extends javax.swing.JPanel implements Stream.Listener{
    ...
    private void initComponents() {
        ...
        tglAudio.setToolTipText("No Audio Switch (Select if muted Video Sources)");
        ...
        panPreview.add(tglAudio, java.awt.BorderLayout.NORTH);
        ...
        tglIPCam.setPreferredSize(new java.awt.Dimension(20, 20));
        panPreview.add(tglIPCam, java.awt.BorderLayout.PAGE_END);
