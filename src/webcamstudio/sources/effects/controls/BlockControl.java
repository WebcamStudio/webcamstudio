...
public class BlockControl extends javax.swing.JPanel {
     ...
     * @param effect */
    public BlockControl(Block effect) {
        initComponents();
        this.effect=effect;
        slider.setValue(effect.getSize());
    }
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(slider, javax.swing.GroupLayout.DEFAULT_SIZE, 330, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void sliderStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderStateChanged
        effect.setSize(slider.getValue());
