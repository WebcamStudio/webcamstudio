...
public class AudioMixerPanel extends javax.swing.JPanel {
    ...
    public AudioMixerPanel(Layout l,AudioMixer mixer) {
        ...
        sliderSysVolume.setValue(layout.getSysVolume());
    ...
    private void initComponents() {
        ...
        sliderSysVolume = new javax.swing.JSlider();
        ...
        jLabel6.setText(bundle.getString("SYSTEM")); // NOI18N
        jLabel6.setName("jLabel6"); // NOI18N

        jLabel7.setText(bundle.getString("VOLUME")); // NOI18N
        jLabel7.setName("jLabel7"); // NOI18N

        sliderSysVolume.setPaintLabels(true);
        sliderSysVolume.setPaintTicks(true);
        sliderSysVolume.setName("sliderSysVolume"); // NOI18N
        sliderSysVolume.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                sliderSysVolumeStateChanged(evt);
            }
        });
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(49, 49, 49)
                        .addComponent(sliderSysVolume, javax.swing.GroupLayout.DEFAULT_SIZE, 273, Short.MAX_VALUE)))
                .addContainerGap())
        );
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(jLabel7))
                    .addComponent(sliderSysVolume, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void sliderVolumeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderVolumeStateChanged
        ...
        if (layout.isActive()){
            audioMixer.setMicVolume(sliderVolume.getValue());
        }
    ...
    private void sliderSysVolumeStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_sliderSysVolumeStateChanged
        layout.setSysVolume(sliderVolume.getValue());
        if (layout.isActive()){
            audioMixer.setSysVolume(sliderVolume.getValue());
        }
    }//GEN-LAST:event_sliderSysVolumeStateChanged
    ...
    private javax.swing.JSlider sliderSysVolume;
