...
public class Shapes {
    ...
    public Shapes() {
        ...
        java.util.ResourceBundle resourceMap = java.util.ResourceBundle.getBundle("webcamstudio/resources/Shapes",java.util.Locale.getDefault());
        ...
        while (keyList.hasNext()) {
            ...
            if (imageName != null && imageName.toLowerCase().endsWith("png")) {
                img = java.awt.Toolkit.getDefaultToolkit().getImage(java.net.URLClassLoader.getSystemResource("webcamstudio/resources/shapes/" + imageName.toLowerCase()));
