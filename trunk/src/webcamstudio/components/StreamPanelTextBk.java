 ...
 */
public class StreamPanelTextBk extends javax.swing.JPanel implements Stream.Listener, StreamDesktop.Listener{
    ...
    public StreamPanelTextBk(Stream stream) {
...
//        setToolTipText(stream.getContent());
    ...
    class clock extends TimerTask{
        ...
        public void run() {
            ...
            StreamPanelTextBk.clock.this.stop();
        }
        public void stop() {
            stopClock=true;
        }
